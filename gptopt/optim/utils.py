...
def get_optimizer(opt_config: dict, lr = 1e-3) -> Tuple[torch.optim.Optimizer, dict]:
    ...
    if name == 'sgd':
        ...
        hyperp = {'lr': lr,
                  ...
                  'output_cov_mode': opt_config.get('output_cov_mode', None),
                  'abs_damping': opt_config.get('abs_damping', None),
                  'trace_damping': opt_config.get('trace_damping', None),
                  'precond_only_opnorm': opt_config.get('precond_only_opnorm', False),
